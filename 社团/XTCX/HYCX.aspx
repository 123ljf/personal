<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HYCX.aspx.cs" Inherits="XTCX_HYCX" %>
                        ...
                        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                                        ...
                                        <tr>
                                            <td height="22" valign="middle">
                                                &nbsp;&nbsp; 快速查询： <asp:DropDownList ID="ddlCXLX" runat="server" 
                                                    ...
                                                    <asp:ListItem Value="hyxm">会员名称</asp:ListItem>  
                                                     <asp:ListItem Value="HYBJ">班级</asp:ListItem> 
                                                      <asp:ListItem Value="HYSS">宿舍</asp:ListItem> 
                                                      <asp:ListItem Value="ZW">职位</asp:ListItem>                                                       
                                                </asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <td>
                            	<asp:GridView ID="gvData" runat="server" AllowPaging="True" 
                                    ...
                                    <Columns>
                                        <asp:ButtonField CommandName="Sel" DataTextField="HYXM" HeaderText="会员名称">
                                            <ItemStyle HorizontalAlign="Center"  />
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:ButtonField>
                                        <asp:BoundField DataField="HYXB" HeaderText="会员性别">
                                            <ItemStyle HorizontalAlign="Center" />
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="HYZY" HeaderText="专业">
                                            <ItemStyle HorizontalAlign="Center" />
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="HYBJ" HeaderText="班级">
                                            <ItemStyle HorizontalAlign="Center" />
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:BoundField> 
                                         <asp:BoundField DataField="HYSS" HeaderText="宿舍">
                                            <ItemStyle HorizontalAlign="Center" />
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:BoundField> 
                                        ...
                                        <asp:BoundField DataField="HYSS" HeaderText="宿舍">
                                         ...
                                         <asp:BoundField DataField="STBMC" HeaderText="所属社团">
                                          ...
                                          <asp:BoundField DataField="HF" HeaderText="会费">
                                            <ItemStyle HorizontalAlign="Center" />
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:BoundField> 
