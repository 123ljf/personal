...
if(a.cdiv){if(a.cdiv.qmtree&&a.cdiv.style.position!="relative"){qmad.ibcss.cura=a;setTimeout("qm_ibcss_wait_relative()",10);return;}var aa=a.cdiv.childNodes;for(var i=0;i<aa.length;i++){if(aa[i].tagName=="A"&&aa[i].qmibulletcss)qm_ibcss_position(aa[i],aa[i].qmibulletcss);}}}/* ]]> */</script>
	...
	<body  >
		<form id="Form1"  runat="server">
	        ...
	        <li><a class="qmparent" href="#">数据管理 </a>

		        <ul> 
		         <li><a href="SJGL/HYEdit.aspx" target="OfficeMain" >添加会员</a></li>
		             <li><a href="SJGL/HYGL.aspx" target="OfficeMain" >会员信息管理</a></li>
		              <li><a href="SJGL/STEdit.aspx" target="OfficeMain" >添加社团</a></li>
			        <li><a href="SJGL/STGL.aspx" target="OfficeMain" >社团管理</a></li>
			        
		        </ul></li>
		         <li><a class="qmparent" href="#">信息修改</a> 
		        <ul>
		        <li><a href="XXXG/HYXXXG.aspx" target="OfficeMain" >会员信息修改</a></li>
		        <li><a href="XXXG/STXXXG.aspx" target="OfficeMain" >社团信息修改</a></li>
		        <li><a href="XXXG/HFXXXG.aspx" target="OfficeMain" >会费信息修改</a></li> 
		        </ul></li>

	        <li><a class="qmparent" href="#">系统查询</a>

		        <ul>
		        <li><a href="XTCX/HYCX.aspx" target="OfficeMain"  >会员信息查询</a></li>
		        <li><a href="XTCX/STCX.aspx"  target="OfficeMain" >社团信息查询</a></li>
		        <li><a href="XTCX/HFCX.aspx" target="OfficeMain" >会费信息查询</a></li> 
		        </ul></li>

	        <li><a class="qmparent" href="#">系统帮助</a>

		        <ul>
		        <li><a href="HelpPage.aspx" target="OfficeMain" >帮助文档</a></li> 
		        </ul></li>

	        <li><a class="qmparent" href="#">系统关于</a>

		        <ul> 
		        <%if (Session["LoginUser"] != null && ((LoginUser)Session["LoginUser"]).JSID==1)
                { %>
		        <li><a href="SYSHY/ADDYH.aspx" target="OfficeMain" >用户添加</a></li> 
		        <li><a href="SYSHY/YHGL.aspx" target="OfficeMain" >用户管理</a></li> 
		         <%
                   }%>
		        <li><a href="SYSAbout.aspx" target="OfficeMain" >关于系统</a></li> 
		        </ul></li>
		        <li><a class="qmparent" href="#">系统退出</a>

		        <ul> 
		          
		        <li><a href="OutPage.aspx" target="_parent">退出系统</a></li> 
		        </ul></li>
